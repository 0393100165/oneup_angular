...
export class DataService {
  ...
  private getAllProductList(): Observable<any> {
    return this.http.get<ProductInfo>(`${this.REST_API_SERVER}/api/products`, { headers: this.headers });
  }

  public getCategoryList() {
    return this.http.get(`${this.REST_API_SERVER}/api/categorys`, { headers: this.headers });
  }
  ...
  getMenuList(): Observable<MenuInfo[]> {
    return this.http.get<MenuInfo[]>('./assets/data/menu-list.json', { headers: this.headers });
  }
